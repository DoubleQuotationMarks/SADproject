...
const RegisterPage = ( { setUserID, setPassword, setName, Gender, setGender, setEmail, setPhone, Birthday, setBirthday, setWeight, setHeight, setRP, setRC } ) => {
    ...
    return (
        <div className='background' >
            ...
            <div className='login_register_button'>
                <Button onClick={()=>{setRP(false); setRC(true);}}>完成</Button>
            </div>
            <br></br>
            <br></br>
            <br></br>
